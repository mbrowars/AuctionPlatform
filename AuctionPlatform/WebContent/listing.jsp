...
<body>
	...
	<div class="login-block">
	    ...
	    <form action="createAuction" method="post">
		    ...
		    <input placeholder="Titel" name="title" type="text" /> 
			<input placeholder="Startgebot"	name="bid" type="text" /> 
			<input placeholder="Auktionsende" name="end" type="text" /> 
			<input placeholder="Beschreibung" name="desc" type="text" /> 
			<input placeholder="AuktionsID"	name="id" type="text" />
